...
for frame in range(init1-1,len(traj)-1,step):
    traj=gsd.hoomd.open(name=filename, mode='rb')
...
filename3 = "Polydens_vs_time_"+"_Isodiamond_network_diffusive"+"_Ntot_"+str(Ntot)+"_vol_frac"+str(fraction)+"_densratio_"+str(densratio)+"_molfrac_"+str(molefrac)+"_kT_"+str(kbT)+".txt"
