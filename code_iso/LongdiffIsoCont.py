...
filename2 = "/lustre/project/nhr-trr146/jvishnu/Regnetbigger/isotropic/trajectoryContinueIso"+str(sample)+"_diamond_network_diffusive"+"_Ntot_"+str(N)+"_vol_frac"+str(vol_frac)+"_densratio_"+str(densratio)+"_molfrac_"+str(molefrac)+"_kT_"+str(kbT)+".gsd"
...
hoomd.dump.gsd(filename2, group=all ,period=period,phase=phase,overwrite =False,dynamic=['momentum']);  #dump initial cofiguration:
