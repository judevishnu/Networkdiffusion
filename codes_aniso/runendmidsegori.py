...
#SBATCH --mem=89G
#SBATCH --array=0-8
#SBATCH --output=mpiprobseg_out_%A_%a.out
#SBATCH -n 20
#SBATCH -p smp
#SBATCH -A m2_trr146
#SBATCH -C broadwell
...
#pse_sim_script="/lustre/project/m2_komet331hpc/jvishnu/Reg_network/Reg_net_bigger/blockdensity.py"
pse_sim_script="/lustre/project/m2_trr146/jvishnu/Regnetbigger/Combined/EndMidsegmentorient.py"
#pse_sim_script="/lustre/project/m2_trr146/jvishnu/Regnetbigger/Combined/EndMidsegmentorient1.py"

. /home/jvishnu/vhoomd/bin/activate
module load lang/Python/3.10.8-GCCcore-12.2.0

module load  lib/mpi4py/3.1.4-gompi-2022b 

#TASK_ID=
mpiexec -n $SLURM_NTASKS python3 $pse_sim_script ${ptlarray[${SLURM_ARRAY_TASK_ID}]} ${fractionarray[${SLURM_ARRAY_TASK_ID}]} ${densratio[$SLURM_ARRAY_TASK_ID]}  ${molefrac[$SLURM_ARRAY_TASK_ID]}  40
#srun python3 $pse_sim_script 3 ${ptlarray[${TASK_ID}]} ${fractionarray[${TASK_ID}]} ${densratio[${TASK_ID}]}  ${molefrac[${TASK_ID}]}  
