    ...
    for sample in range(1,samples):
        ...
        for k in range(0,len(nbin_array)):
            ...
            if rank == size-1:
                ...
                print("rank :",rank,"size-1 :",size-1,"start_index :",start_index,"end_index :",end_index)

            data2 = numpy.zeros((int((end_index-start_index)/step),1),dtype=float)
            for frame in range(start+start_index,start+end_index,step):
                print("sample :",sample,"rank :",rank,"nbin :",nbin,"frame : ",frame,"int((frame-(start+start_index))/step) :",int((frame-(start+start_index))/step),"start_index :",start_index,"end_index :",end_index)
